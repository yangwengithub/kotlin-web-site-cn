...
Kotlin Gradle 插件 1.3.50 适用于 Gradle 4.1 及更高版本。
...
```groovy
plugins {
    id 'org.jetbrains.kotlin.＜……＞' version '1.3.50'
}
```
...
Kotlin Gradle 插件 1.3.50 适用于 Android Gradle 插件 3.0 及更高版本。
...
Kotlin/JVM 与 Kotlin/JS 项目均支持增量编译。对于 Kotlin 1.1.1 起的 Kotlin/JVM 项目以及自 Kotlin 1.3.31 起的 Kotlin/JS 项目默认启用增量编译。
