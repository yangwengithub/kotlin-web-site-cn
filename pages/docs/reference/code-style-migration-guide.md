...
![代码格式差异](/assets/images/tutorials/codestyle-migration/code-formatting-diff.png)
...
![Reformat code 对话框](/assets/images/tutorials/codestyle-migration/reformat-code.png)
